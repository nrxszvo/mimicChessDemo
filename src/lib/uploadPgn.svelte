...
>
	<div class="mb-2 text-center">
		Paste a raw <Link
			href="https://en.wikipedia.org/wiki/Portable_Game_Notation">pgn</Link
		> or
		<Link href="https://lichess.org">lichess</Link> game URL below to estimate each
		player's Elo rating by position:
	</div>
	<form
